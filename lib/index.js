$( document ).ready(function() {
  ...
  // $("#btn-breakfast").on('click', function(){
  //   $("#inputs-post-breakfast").show();
  // });

  $("#btn-post-submit-breakfast").on('click', function() {
    var food = $("#field-post-breakfast").val();
    var cal  = $("#field-post-breakfast-calories").val();
    var day  = $("#dates-list :selected").val();
    $.ajax({
      type: 'POST',
      url: 'https://damp-garden-70659.herokuapp.com/api/v1/meals/1/',
      contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
      data: { "day": day },
      success: function(result) {
        alert("Date has been added");
