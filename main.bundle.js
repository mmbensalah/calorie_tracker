...
/***/ (function(module, exports) {
	...
	function getAllDates() {
	  $.ajax({
	    ...
	    success: function success(result) {
	      ...
	      $(".get-all-dates").html("<select class='field' id='dates-list'> " + contents + "</select>");
	    }
	  });
	}
	...
	function getAllMealFoods(day) {
	  $.ajax({
	    ...
	    success: function success(result) {
	      ...
	      $("#breakfast").html("<p class='container' id='container-breakfast'> " + breakfast + " Total Calories: " + breakCalories + " <br> Calories Left: " + calculateGoal(breakCalories) + "</p>");
	      ...
	      $("#lunch").html("<p class='container' id='container-lunch'> " + lunch + " Total Calories: " + lunchCalories + " <br> Calories Left: " + calculateGoal(lunchCalories) + "</p>");
	      ...
	      $("#dinner").html("<p class='container' id='container-dinner'> " + dinner + " Total Calories: " + dinnerCalories + " <br> Calories Left: " + calculateGoal(dinnerCalories) + "</p>");
	      ...
	      $("#snack").html("<p class='container' id='container-snack'> " + snack + " Total Calories: " + snackCalories + " <br> Calories Left: " + calculateGoal(snackCalories) + "</p>");
	    },
	    error: function error(response) {
	      alert(response.responseJSON.error);
	    }
	  ...
	  $.ajax({
	    ...
	    success: function success(results) {
	      results.forEach(function (day) {
	        $(".calendar").append("<p class='container' id='container-date'> " + formatDate(day.date) + "</p>");
	        var mealName = '';
	...
	function dateSort(arr) {
	  arr.sort(function (a, b) {
	    var dayA = formatDate(a.day),
	        dayB = formatDate(b.day);
